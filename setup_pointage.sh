...
# 6. Création du service Systemd (Démarrage automatique)
echo "--- 6. Création du service de démarrage automatique ---"
...
systemctl start pointage-service.service

echo "=============================================="
echo "INSTALLATION TERMINÉE !"
echo "Le service tourne en arrière-plan."
echo "Pour voir les logs : journalctl -u pointage-service -f"
echo "=============================================="
